...
import { User, Settings, LogOut, Crown, CreditCard, HelpCircle, Menu, Bell, Plus, Clock, Calendar as CalendarIcon, Home, Star, DollarSign, BarChart3, AlertCircle, Cog } from "lucide-react";
...
export function HeaderMenu() {
  ...
  const dashboardNavItems = [
    ...
    { title: "Reminders", url: "/reminders", icon: AlertCircle, active: location === "/reminders" },
    ...
    <header className="flex items-center justify-between px-3 py-2 sm:p-3 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
        <Link href={isMarketingPage ? "/" : "/dashboard"} className="flex items-center gap-2 hover-elevate rounded-md px-2 py-1 -mx-2 -my-1" data-testid="link-dashboard-logo">
          ...
          <span className="font-semibold text-sm sm:text-lg hidden xs:block truncate">SubTracker</span>
        </Link>
