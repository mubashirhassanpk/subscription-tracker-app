...
export function NotificationCenter() {
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent 
        className="w-[75vw] sm:w-96 max-w-xs p-0 mx-6" 
        align="end"
        side="bottom"
        sideOffset={8}
      ...
      >
        <Card className="border-0 shadow-none">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 px-3 py-1.5">
          ...
          <CardContent className="p-0">
            <ScrollArea className="h-[35vh] sm:h-80 max-h-80">
              {isLoading ? (
                ...
                <div className="space-y-1">
                  {notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={cn(
                        "flex flex-col sm:flex-row items-start gap-2 p-2.5 hover-elevate transition-colors border-b border-border last:border-b-0",
                    ...
                    >
                      ...
                      <div className="flex items-start gap-2 w-full sm:hidden">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-muted-foreground leading-snug mb-1 break-words line-clamp-2">
