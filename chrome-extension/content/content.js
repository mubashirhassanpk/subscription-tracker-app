    ...
    notification.innerHTML = `
      <div class="notification-content">
        <div class="notification-header">
          ...
          <div class="notification-title">Subscription Detected</div>
        ...
        <div class="notification-body">
          <div class="service-info">
            <h4>${service.name}</h4>
            <p class="service-details">${service.category} • $${service.cost}/month</p>
          </div>
          <div class="notification-actions">
            <button class="btn-add" onclick="window.subscriptionDetector.addToTracker('${service.name}', '${service.cost}', '${service.category}')">
              Add to Tracker
            </button>
            <button class="btn-dismiss" onclick="window.subscriptionDetector.hideSubscriptionDetection()">
              Dismiss
            </button>
          </div>
        </div>
