...
export class EmailService {
  ...
  async sendSubscriptionReminder(
    ...
    try {
      ...
      if (preferences.includeSpendingSummary && userSubscriptions) {
        spendingSummary = this.calculateSpendingSummary(userSubscriptions);
      }
      ...
      const templateData = {
        ...
        includeActionButtons: preferences.includeActionButtons,
        unsubscribeUrl: `${process.env.BASE_URL}/unsubscribe?email=${encodeURIComponent(preferences.emailAddress)}`
      };
